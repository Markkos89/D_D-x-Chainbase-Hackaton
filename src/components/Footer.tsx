                        ...
                        <div className="flex flex-wrap items-center md:justify-between justify-center">
                            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                                <div className="text-sm text-blueGray-500 font-semibold py-1">
                                    Copyright © Marcos and Psique<span id="get-current-year"> - 2023</span> {/*<a href="https://github.com/Markkos89/D_D-x-Chainbase-Hackaton/tree/main/src/pages" className="text-blueGray-500 hover:text-gray-800" target="_blank"> Blockchain by
